...
ALIAS_EXTRA = {
    ...
    "广州大学附属中学增城实验学校（增城广附）": ["广大附中增城实验中学", "增城广附", "广州大学附属中学增城实验学校"],
    "广州市增城区应元学校（增城应元）": ["增城应元", "广州市增城区应元学校"],
    "广州市黄广附属学校（增城黄广，民办）": ["黄广附属学校", "黄广学校", "黄冈中学广州学校", "增城黄广"],
}
...
EXTRA_COORDS = {
    ...
    "广州市黄广附属学校（增城黄广，民办）": {
        "lng": 113.804437, "lat": 23.180370,
        "addr": "南北大道（黄冈中学广州增城学校）",
        "source": "高德POI：广州市黄广附属学校（typecode 141202）",
    },
}

DISTRICTS = ["越秀区", "荔湾区", "海珠区", "天河区", "白云区", "黄埔区", "番禺区", "增城区"]
