...
const SRC_REMAP_INV = Object.fromEntries(Object.entries({
  ...
  'primary/enrollments/2026-baiyun': 'primary/enrollment/dist/2026-baiyun',
  'primary/enrollments/2026-haizhu': 'primary/enrollment/dist/2026-haizhu',
  'primary/enrollments/2026-huangpu': 'primary/enrollment/dist/2026-huangpu',
  'primary/enrollments/2026-liwan': 'primary/enrollment/dist/2026-liwan',
  'primary/enrollments/2026-panyu': 'primary/enrollment/dist/2026-panyu',
  'primary/enrollments/2026-tianhe': 'primary/enrollment/dist/2026-tianhe',
  'primary/enrollments/2026-yuexiu': 'primary/enrollment/dist/2026-yuexiu',
  'primary/schools-backfill': 'primary/transition/dist/schools-backfill',
  'primary/middle_enroll_notes': 'middle/enrollment/src/middle_enroll_notes',
}).map(([k, v]) => [v, k]));
