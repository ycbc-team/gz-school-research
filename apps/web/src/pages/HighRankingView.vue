...
const groups = computed(() => buildHighRankingGroups({ highSchools, highLevels, highScores2025, highScores2026, entities }, groupBy.value));
...
@media (max-width: 600px) {
  .filter-bar { top: 58px; }.filter { flex: 1; padding: 7px 5px; font-size: 12px; }
