...
CASES = [
    ("金广实验学校", "440111", "小学", "gz-440111-6f87dc56"),  # 2026-09-22 钟落潭筹备名点位已删（=星悦实验学校），
                                             # 裸名落金沙洲金域蓝湾校区（御金沙 eb640c74 同法人）
    ...
    ("广州市星执学校", "440113", "小学", "gz-440113-883c58c4"), # 星执小学部=执信中学附属小学（实体表别名「星执学校」收敛；exact 命中初中 999fb9c0 但学段不符 → 走 alias 找小学，禁止跨学段错挂）
    ("广州市星执学校", "440113", "初中", "gz-440113-999fb9c0"), # 初中/高中场景精确命中本体（不受小学 case 影响）
]
