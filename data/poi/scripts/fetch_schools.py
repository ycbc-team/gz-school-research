...
def main():
    ...
    with open(os.path.join(data_dir, "primary_poi.json"), "w", encoding="utf-8") as f:
    ...
    print(f"输出: {os.path.join(data_dir, 'primary_poi.json')}")
