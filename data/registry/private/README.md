...
| 脚本 | 职责 |
| --- | --- |
| `build_minban_official.py` | 番禺民办名单官方源自动解析（`data/primary/enrollment/parsed/_transcripts/panyu_2026_official.json` 的「民办招生计划」sheet，39 所）；`--check` 模式供 drift 检查（禁手改） |
